...
| :---------------------------------------------------- | :----------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------ |
| [lsp_bash](/plugins/lsp_bash.lua?raw=1)               | Bash                           | [bash-language-server](https://github.com/bash-lsp/bash-language-server)                                                                                                           | Linux, Mac, Windows |
...
| [lsp_php](/plugins/lsp_php.lua?raw=1)                 | PHP                            | [Intelephense](https://intelephense.com/)                                                                                                                                          | Linux, Mac, Windows |
| [lsp_python](/plugins/lsp_python.lua?raw=1)           | Python                         | [pyright](https://github.com/Microsoft/pyright), [Ruff](https://github.com/astral-sh/ruff)                                                                                         | Linux, Mac, Windows |
